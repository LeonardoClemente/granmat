...
fcRho=100000 #Factor original : KG/m^3 -> g/m^3
fcK=100000 #Factor original : kg/s^2 -> g/s^2 
fcGamma=100000
SBB.mu_s[0] = 0.4
SBB.mu_d[0] = 0.4
SBB.rho[0] = 14
...
ddx= 2.1*r
SBB.defineWorldBoundaries(L=np.array([minlx*1.1,ly,lz*1.1]),origo = [0,0,0], dx=ddx) #quitar el *4
SBB.initGrid()#dx=ddx)
# Define the temporal parameters, e.g. the total time (total) and the file
# output interval (file_dt), both in seconds
SBB.initTemporal(total = 1, file_dt = .005, dt=0.5e-6)
